...
const {
  getAllUsersHandler,
} = require("../handlers/User/getAllUserHandler");
const {
  getUserByIdHandler,
} = require("../handlers/User/getUserByIdHandler");
const {
  createUserHandler,
} = require("../handlers/User/createUserHandler");
const {
  updateUserHandler,
} = require("../handlers/User/updateUserHandler");
const {
  deleteUserHandler,
} = require("../handlers/User/deleteUserHandler");
